        ...
        <div class="bigBox smallBorder center" style="width:811px;" id='about'>
            ...
            <div class='smallBorder center' style="width:750px;" id='aboutText'>
                            <div id="gameWindow" >
                                <h2><?=$title?></h2>
                                <p>
                                As part of the <a href='http://neuron.illinois.edu/curriculum/doyousee.php'>Do you see what I see?</a> unit, students investigate how color is perceived. Try this interactive applet to see how you might sort these different colors. It is important to remember that there isn't one correct way of doing this-go ahead and try it and then compare how you sorted to ways that other people sorted the same colors. <br />
You can see how others sorted a specific color by placing your cursor over a specific paint chip after its been dumped out of the bucket.
                                </p>
                                <p>

You'll also be able to see the official name of the paint chip--that is the name given by the makers of Crayola crayons. Do you agree with the names?
                                </p>
                                <div id='gameChange'>
                                    <p>
